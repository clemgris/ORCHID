...
from franka_3blocks_env_pybullet.Franka3BlocksEnv import TASK_NAMES as tasks
from franka_3blocks_env_pybullet.Franka3BlocksEnv import Franka3BlocksEnvPyBullet
from hierarchical_policy.hierarchical_model_franka3b import HierarchicalModel
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--policy_results_folder", type=str, help="Results folder", default=None
    )
